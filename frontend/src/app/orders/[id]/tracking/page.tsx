                ...
                <div className="flex-1 min-w-0 pb-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-gray-500">
                      {step.timestamp.toLocaleDateString('fr-FR')} à {step.timestamp.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                    </span>
                  </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {order.estimatedDelivery.toLocaleDateString('fr-FR')} à {order.estimatedDelivery.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                </p>
              </div>
            </div>
          </div>
