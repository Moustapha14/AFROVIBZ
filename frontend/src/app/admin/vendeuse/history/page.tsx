...
const mockHistory: OrderHistory[] = [
  ...
  },
  {
    ...
    items: [{ name: 'MacBook Air M2', quantity: 1, price: 650000 }],
    total: 650000,
    status: 'completed',
  ...
  },
  {
    ...
    items: [{ name: 'Samsung Galaxy S24 Ultra', quantity: 1, price: 750000 }],
    total: 750000,
    status: 'cancelled',
    deliveryOption: 'Express',
                ...
                {filteredHistory.map(item => (
                  <tr key={item.id} className='hover:bg-gray-50'>
                    ...
                    <td className='px-6 py-4'>
                      <div className='text-sm text-gray-900'>{item.items.length} produit(s)</div>
