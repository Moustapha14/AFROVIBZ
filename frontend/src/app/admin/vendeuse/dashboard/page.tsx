        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-16'>
            <div className='flex items-center space-x-4'>
              ...
              <div>
                <h1 className='text-xl font-bold text-gray-900'>Tableau de Bord Vendeuse</h1>
                <p className='text-sm text-gray-500'>{user.displayName} • Gestion des commandes</p>
              </div>
            </div>
          ...
          {stats &&
            Object.entries(stats).map(([status, count]) => (
              <div key={status} className='bg-white rounded-lg shadow-sm p-6'>
                <div className='flex items-center'>
                  <div
                    className={`p-3 rounded-lg ${getStatusColor(status).replace('text-', 'bg-').replace('bg-yellow-100', 'bg-yellow-100').replace('bg-blue-100', 'bg-blue-100').replace('bg-green-100', 'bg-green-100').replace('bg-red-100', 'bg-red-100')}`}
                  >
        ...
        <div className='bg-white rounded-lg shadow-sm'>
          <div className='px-6 py-4 border-b border-gray-200'>
            <div className='flex items-center justify-between'>
              <h2 className='text-lg font-semibold text-gray-900'>Commandes Récentes à Traiter</h2>
              <Button
                  ...
                  >
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='text-right'>
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(order.logisticsStatus)}`}
                        >
