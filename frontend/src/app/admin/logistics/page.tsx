...
import { Search, Truck, MapPin, Clock, CheckCircle, AlertCircle, Plus, Edit, Trash2 } from 'lucide-react';
...
export default function SuperAdminLogisticsPage() {
  ...
  const handleToggleCarrierActive = (carrierId: string) => {
    setCarriers(carriers.map(c => 
      c.id === carrierId ? { ...c, isActive: !c.isActive } : c
    ));
                  ...
                  <div key={zone.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          Délai: {zone.deliveryTime} • Coût: {zone.cost.toLocaleString('fr-FR')} FCFA
                        </p>
                        <p className="text-sm text-gray-600">
                  ...
                  <div key={method.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          Délai: {method.deliveryTime} • Coût: {method.cost.toLocaleString('fr-FR')} FCFA
                          {method.minOrderAmount && ` • Min: ${method.minOrderAmount.toLocaleString('fr-FR')} FCFA`}
                        </p>
                      </div>
                      <div className="flex items-center space-x-2">
                        <button
