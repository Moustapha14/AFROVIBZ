          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='mt-2 text-gray-600'>
                Statistiques détaillées et analyses de la plateforme
              </p>
            </div>
            <Button
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div className='flex items-center mt-2'>
                  ...
                  <span
                    className={`text-sm ml-1 ${revenueGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div className='flex items-center mt-2'>
                  ...
                  <span
                    className={`text-sm ml-1 ${ordersGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div className='flex items-center mt-2'>
                  ...
                  <span
                    className={`text-sm ml-1 ${usersGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div className='flex items-center mt-2'>
                  ...
                  <span
                    className={`text-sm ml-1 ${conversionGrowth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
                    ...
                    <tr key={product.name} className='hover:bg-gray-50'>
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <div className='flex items-center'>
                          ...
                          <span
                            className={`text-sm ml-1 ${product.growth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                          >
