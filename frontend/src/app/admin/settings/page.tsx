...
export default function SuperAdminSettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'payment' | 'email' | 'appearance' | 'notifications' | 'security'>('general');
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Envoyer une confirmation lors de la commande</p>
                    </div>
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Notifier les changements de statut de commande</p>
                    </div>
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Exiger une authentification à deux facteurs</p>
                    </div>
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                    ...
                    <div className="flex items-center">
                      <label className="flex items-center">
                        <input
                          ...
                          className="rounded border-gray-300 text-black focus:ring-black"
                        />
                        <span className="ml-2 text-sm text-gray-700">Exiger un mot de passe fort</span>
                      </label>
                    </div>
                  </div>
                </div>
