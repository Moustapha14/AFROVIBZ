...
export const metadata = {
  ...
  description: 'Informations sur nos options de livraison au Gabon. Livraison gratuite dès 50,000 FCFA.'
};
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-yellow-800">
                <p>• <strong>Délais prolongés:</strong> +1-2 jours pendant les fêtes et périodes de forte demande</p>
                <p>• <strong>Zones reculées:</strong> Certaines zones peuvent nécessiter un délai supplémentaire</p>
                <p>• <strong>Produits volumineux:</strong> Les produits tech lourds peuvent nécessiter une livraison spécialisée</p>
                <p>• <strong>Météo:</strong> Les conditions météorologiques peuvent affecter les délais</p>
              </div>
            </div>
          </div>
        </div>
