import { Ruler, ArrowLeft, User, Baby, Shirt, Package } from 'lucide-react';
...
export const metadata = {
  ...
  description:
    'Guide des tailles pour vêtements femmes, hommes et enfants. Trouvez votre taille parfaite.',
};
      ...
      <div className='mobile-container py-6 sm:py-8 lg:py-12'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800'>
                <div>
                  ...
                  <ul className='space-y-1'>
                    <li>
                      • <strong>Poitrine :</strong> Tour de poitrine au niveau le plus fort
                    </li>
                    <li>
                      • <strong>Taille :</strong> Tour de taille au niveau le plus fin
                    </li>
                    <li>
                      • <strong>Hanches :</strong> Tour de hanches au niveau le plus fort
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className='space-y-1'>
                    <li>
                      • <strong>Poitrine :</strong> Tour de poitrine sous les bras
                    </li>
                    <li>
                      • <strong>Taille :</strong> Tour de taille naturelle
                    </li>
                    <li>
                      • <strong>Hanches :</strong> Tour de hanches au niveau le plus fort
                    </li>
        ...
        <div className='mb-12'>
          <div className='flex items-center space-x-3 mb-6'>
            ...
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900'>Tailles Femmes</h2>
          </div>
              ...
              <table className='w-full text-xs sm:text-sm'>
                <thead>
                  <tr className='bg-gray-50 border-b border-gray-200'>
                    ...
                    <th className='text-left p-3 sm:p-4 font-semibold text-gray-900'>
                      Poitrine (cm)
                    </th>
                    <th className='text-left p-3 sm:p-4 font-semibold text-gray-900'>
                      Taille (cm)
        ...
        <div className='mb-12'>
          <div className='flex items-center space-x-3 mb-6'>
            ...
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900'>Tailles Hommes</h2>
          </div>
        ...
        <div className='mb-12'>
          <div className='flex items-center space-x-3 mb-6'>
            ...
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900'>Tailles Enfants</h2>
          </div>
          ...
          <div className='flex items-start space-x-3'>
            ...
            <div>
              ...
              <div className='space-y-2 text-sm text-yellow-800'>
                <p>
                  • <strong>Entre deux tailles ?</strong> Choisissez la taille supérieure pour plus
                  de confort
                </p>
                <p>
                  • <strong>Matières extensibles :</strong> Vous pouvez prendre une taille en
                  dessous
                </p>
                <p>
                  • <strong>Vêtements amples :</strong> Respectez vos mesures exactes
                </p>
                <p>
                  • <strong>Incertitude ?</strong> Contactez-nous, nous vous conseillons !
                </p>
              </div>
            </div>
          </div>
