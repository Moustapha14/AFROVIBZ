...
const mockOrders: Order[] = [
  ...
  },
  {
    ...
    status: 'delivered',
    total: 650000,
    items: [{ name: 'MacBook Air M2', quantity: 1, price: 650000, size: '13"', color: 'Argent' }],
  ...
  },
  {
    ...
    status: 'cancelled',
    total: 450000,
    items: [{ name: 'iPad Pro 12.9"', quantity: 1, price: 450000, size: '256GB', color: 'Argent' }],
    deliveryOption: 'Standard',
        ...
        <div className='bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden'>
          ...
          {filteredOrders.length === 0 && (
            <div className='text-center py-12'>
              ...
              {!searchTerm && selectedStatus === 'all' && (
                <div className='mt-6'>
                  <Button onClick={() => router.push('/products')}>Découvrir nos produits</Button>
                </div>
              )}
            </div>
          )}
