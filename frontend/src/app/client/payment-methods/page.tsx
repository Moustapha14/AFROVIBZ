          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Vos informations de paiement sont chiffrées et sécurisées. Nous ne stockons jamais vos données sensibles.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">
                  {isAddModalOpen ? 'Ajouter une méthode de paiement' : 'Modifier la méthode de paiement'}
                </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      value={formData.type}
                      onChange={(e) => handleInputChange('type', e.target.value as 'card' | 'mobile_money' | 'bank_transfer')}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => handleInputChange('cardType', e.target.value as 'visa' | 'mastercard' | 'american_express')}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          >
                    ...
                    <>
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => handleInputChange('provider', e.target.value as 'moov' | 'airtel' | 'libercom')}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
