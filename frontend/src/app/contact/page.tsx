      ...
      <div className='min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8'>
        <div className='max-w-md w-full text-center'>
          <div className='bg-white rounded-lg shadow-sm p-6 sm:p-8'>
            ...
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900 mb-2'>Message envoyé !</h2>
      ...
      <div className='mobile-container py-6 sm:py-8 lg:py-12'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12'>
          ...
          <div className='order-2 lg:order-1'>
            <h2 className='text-xl sm:text-2xl font-bold text-gray-900 mb-6'>Nos Coordonnées</h2>
