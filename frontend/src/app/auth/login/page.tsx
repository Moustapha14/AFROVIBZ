  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-yellow-400 via-orange-400 to-red-500 sm:bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 sm:hidden'>
        ...
        <div className='absolute top-32 right-8 w-16 h-16 bg-white/20 rounded-full animate-bounce' />
        <div className='absolute bottom-20 left-6 w-12 h-12 bg-yellow-300/30 rounded-full animate-ping' />
        <div className='absolute bottom-40 right-12 w-8 h-8 bg-white/15 rounded-full' />
        ...
        <div className='absolute bottom-1/3 right-6'>
          <div className='w-4 h-4 border-2 border-yellow-300/40 rotate-45' />
        </div>
      </div>
