...
export class ProductImagesService {
   ...
   */
  static async uploadImages(productId: string, files: File[]): Promise<UploadResponse> {
    try {
   ...
   */
  static async reorderImages(productId: string, imageOrder: string[]): Promise<ReorderResponse> {
    try {
      const response = await fetch(`${this.API_BASE}/${productId}/images`, {
        method: 'PUT',
        headers: {
   ...
   */
  static async deleteImage(productId: string, imageId: string): Promise<DeleteResponse> {
    try {
