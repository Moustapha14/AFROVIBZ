...
export default function ProductModal({
      ...
      setFormData({
        ...
        colors:
          product.colors.length > 0
            ? product.colors.map(c => ({ ...c, stock: c.stock.toString() }))
            : [{ name: '', hex: '#000000', stock: '' }],
  ...
  const updateArrayItem = (
    field: 'images' | 'colors' | 'sizes' | 'tags',
    index: number,
    value: any
  ) => {
    setFormData(prev => ({
                  ...
                  <div key={index} className='flex gap-2'>
                    <Input
                      ...
                      onChange={e => {
                        ...
                        const uploadedImages = formData.images.filter(img =>
                          img.startsWith('data:')
                        );
                        setFormData(prev => ({
                          ...prev,
            ...
            {formData.colors.map((color, index) => (
              <div key={index} className='grid grid-cols-1 md:grid-cols-4 gap-2 mb-2'>
                <Input
                  value={color.name}
                  onChange={e =>
                    updateArrayItem('colors', index, { ...color, name: e.target.value })
                  }
                ...
                <Input
                  ...
                  value={color.hex}
                  onChange={e =>
                    updateArrayItem('colors', index, { ...color, hex: e.target.value })
                  }
                  className='h-10'
                />
                <Input
                  ...
                  value={color.stock}
                  onChange={e =>
                    updateArrayItem('colors', index, { ...color, stock: e.target.value })
                  }
                  placeholder='Stock'
                />
